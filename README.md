...
> Full installation, configuration, and llama-server setup ? [docs/installation.md](docs/installation.md)> Can't see the file? View it on [GitHub](https://github.com/milika/EgoVault/blob/main/docs/installation.md).
---
...
| Telegram export | ? |
| WhatsApp, Facebook Messenger | ?? planned |
| Instagram, LinkedIn, Twitter/X, TikTok | ?? planned |
| Obsidian vault, Calendar (ICS) | ?? planned |
